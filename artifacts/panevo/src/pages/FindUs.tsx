    ...
    <div className="w-full">
            ...
            <div className="w-full lg:w-1/2 p-6 flex flex-col max-h-[600px]">
              ...
              <div className="relative mb-6">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-background border border-border text-sm focus:outline-none focus:border-primary"
              ...
              <div className="overflow-y-auto pr-2 space-y-4 flex-1 custom-scrollbar">
                {filteredStores.length > 0 ? (
                  filteredStores.map(store => (
                    <div key={store.id} className="card-lift p-4 border border-border bg-background hover:border-primary/50" style={{ borderRadius: 8 }}>
      ...
      <section className="bg-secondary text-secondary-foreground py-24 text-center">
        <div className="container px-4 max-w-2xl">
          <Reveal>
            <h2 className="text-3xl mb-6 text-white">Not in your city yet?</h2>
          </Reveal>
          <Reveal delay={120}>
          ...
          <Reveal delay={200}>
            <form className="flex flex-col sm:flex-row gap-4" onSubmit={handleCityRequest}>
              <input
                ...
                className="flex-1 bg-white/10 border border-white/20 text-white placeholder:text-white/50 px-4 py-3 focus:outline-none focus:border-primary"
                style={{ borderRadius: 8 }}
              />
              <input
                type="email"
                ...
                style={{ borderRadius: 8 }}
              />
              <button disabled={isSubmitting} type="submit" className="cta-primary bg-primary text-white px-6 py-3 font-bold hover:bg-primary/90 transition-colors notch-br disabled:opacity-50" style={{ borderRadius: 4 }}>
